                                                    ...
                                                    if (mysqli_errno($connection)) {
                                                        ...
                                                        if ($result) {
                                                            ...
                                                            while ($row = mysqli_fetch_array($result)) {
                                                                ...
                                                                echo"<tr>
                                                                <th scope='row'>{$i}</th>
                                                                <td width='60%'>{$row['page_title']}</td>
                                                                <td width='20%'>{$row['page_reg_date']}</td>
                                                                <td width='20%'>
                                                                <a href='page-edit.php?page={$row['page_name']}' class='btn btn-purple btn-icon bottom5 right5'>
                                                                <i class='fa fa-edit'></i> &nbsp; <span>Edit</span>
                                                                </a>
                                                                
                                                                <a href='page-delete.php?page={$row['page_name']}' class='btn btn-danger btn-icon bottom5 right5'>
