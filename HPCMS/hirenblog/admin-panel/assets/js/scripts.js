...
jQuery(function($) {
            ...
            CKEDITOR.on('instanceCreated', function(event) {
                ...
                if (element.is('h1', 'h2', 'h3') || element.getAttribute('id') == 'taglist') {
                    ...
                    editor.on('configLoaded', function() {
                    	...
                    	//adding new plugins for image browser
                    	
                    	editor.config.extraPlugins = 'imagebrowser';
                    	
                    	//adding data in image browser
                    	
                    	editor.replace('editor1', {
                    		"extraPlugins" : 'imagebrowser',
                    		"imageBrowser_listUrl" : "../media/images_list.json"
                    	});
	...
	CKEDITOR.replace('js-my-textarea', {
		"extraPlugins" : 'imagebrowser',
		"imageBrowser_listUrl" : "/projects/ckeditor-imagebrowser/demo/images/images_list.json"
	});
