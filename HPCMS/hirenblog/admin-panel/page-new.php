...
if ($_POST) {
    ...
    if ($connection) {
        ...
        $query = "insert into pages values(null,'{$pageName}','{$pageContent}',null,'{$pageUrl}','{$pageTitle}','{$environment['blog_name']}');";
                                ...
                                <div class="content-body">    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" id="field-1" placeholder="Enter your title here.." name="txtPageTitle" value="">
                                                </div>
                                            </div>
