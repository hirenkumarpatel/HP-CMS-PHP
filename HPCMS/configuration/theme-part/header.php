...
if ($connection) {
    if (isset($_SESSION['user'])) {
        $query = "select user_display_name,user_profile from users where user_name='{$_SESSION['user']}'";
        $result = mysqli_query($connection, $query);
        if ($result) {
            $row = mysqli_fetch_array($result);
            $displayName = $row['user_display_name'];
            $profilePicture = $row['user_profile'];
        }
    }
}
?>
<div class='page-topbar '>
    ...
    <!-- theme logo starts      ---->
    <div class='logo-area'>
        <img src="assets/images/hpcms-logo1.png" style="margin-left:30px;">
    </div>
    ...
    <div class='quick-area'>
        ...
        <div class='pull-right'>
            <ul class="info-menu right-links list-inline list-unstyled">
                <li class="profile">
                    <a href="#" data-toggle="dropdown" class="toggle">
                        <img src="<?php if ($profilePicture != '') {
    echo $profilePicture;
} else {
    echo'data/profile/user_not_found_male.png';
} ?>" alt="user-image" class="img-circle img-inline">
                        <span><?php if ($displayName != '') {
    echo $displayName;
